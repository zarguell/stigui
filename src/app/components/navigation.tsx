...
const LINKS = [
    { href: `${BASE_PATH}/stigs`, label: "Library" },
    { href: `${BASE_PATH}/whats-new`, label: "What's new" },
    { href: `${BASE_PATH}/dashboard`, label: "Dashboard" },
    { href: `${BASE_PATH}/editor`, label: "Editor" },
    { href: "https://github.com/zarguell/stigui", label: "GitHub" },
];
    ...
    return (
        <nav className="bg-surface/90 backdrop-blur fixed w-full z-20 top-0 start-0 border-b border-border">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
                ...
                <div className="flex items-center md:hidden md:order-2 gap-1">
                    <ThemeToggle />
                    <div className="relative inline-block text-left">
                        ...
                        {isOpen && (
                            ...
                            >
                                {LINKS.map(({ href, label }) => (
                                    <div className="py-1" role="none" key={label}>
                                        <a
                                            href={href}
